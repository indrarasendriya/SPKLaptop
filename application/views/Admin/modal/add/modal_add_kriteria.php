  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="apasih">Add Kriteria</h5>
      </div>
      <?= form_open_multipart('kriteria/addKriteria'); ?>

      <div class="modal-body">
        <div class="form-group">
          <input type="text" class="form-control" id="kode_kriteria" value="<?= $kode; ?>" readonly>
        </div>
        <div class="form-group">
          <input type="text" class="form-control" id="nama_kriteria" name="nama_kriteria" placeholder="Nama Kriteria">
        </div>
        <div class="form-group">
          <input type="text" class="form-control" id="atribut" name="attribut" placeholder="Atribut">
        </div>
        <div class="form-group">
